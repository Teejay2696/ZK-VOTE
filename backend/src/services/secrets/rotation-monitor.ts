 ...
 */
export function checkAllRotations(
  secrets: Record<string, { metadata: SecretMetadata | undefined }>,
): RotationStatus[] {
 ...
 */
export function logRotationStatus(statuses: RotationStatus[]): void {
